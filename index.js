...
⚠️⚠️ إجباري — إلا كانت الطلبية مؤجلة (deferred_date موجود)، زيد سطر إضافي واضح فملخص التأكيد (قبل CONFIRMED_ORDER مباشرة، فنفس بطاقة "خلينا نتأكدو..." اللي فـ## CONFIRMATION) يوضح التاريخ بالضبط، مثلاً: "📅 تاريخ التوصيل المطلوب: [اليوم]، [التاريخ الكامل]" — الزبون خاصو يشوف التاريخ بوضوح فالملخص قبل ما يضغط تأكيد الطلب، ماشي يكتشفو من بعد. ما تنساش هاد السطر أبداً فالطلبيات المؤجلة.
