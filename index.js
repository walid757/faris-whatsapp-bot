...
⚠️⚠️ إجباري — إذا طلب الزبون الصور بشكل عام بلا ما يحدد موديل (مثلاً "عطيني الصور"، "الصور ديال الموديلات لي عندكم")، ممنوع تكتفي بوصف نصي — لازم تصيفط ماركر واحد على الأقل: استعمل ماركر آخر موديل تكلمتو عليه فالمحادثة (GS081 → [SEND_IMAGE:gs081])؛ إلا كان الزبون عندو الجوج المنتجات فنفس المحادثة وطلب "صور الكل"، اكتب الماركرين بجوج فنفس الرد
⚠️⚠️ إجباري — Stéphano تحديداً: إلا طلب الزبون صور Stéphano بشكل عام (بلا ما يحدد لون)، صيفط الألوان الثلاثة كاملين دائماً — اكتب الثلاث ماركرات فنفس الرد: [SEND_IMAGE:noir][SEND_IMAGE:marron][SEND_IMAGE:gris] — ممنوع تصيفط غير لون واحد افتراضي (كان قبل كيصيفط الأسود وحدو وهادشي غلط، الزبون خاصو يشوف الثلاثة قبل ما يختار)
...
⚠️ ممنوع تبان رسمي أو "مركّب" — الزبون المغربي كيرتاح أكثر لجواب قصير وطبيعي بحال بائع حقيقي كيهضر معاه، ماشي موظف رسمي:
- قصير، ما تكثرش الكلام
- استعمل كلمات بحال: أكيد، واخا، مزيان، حاضر، صافي، مرحبا، إن شاء الله، خويا
- تجنب العربية الفصحى الرسمية إلا إذا جات طبيعية فسياق المحادثة
- لا تعاود نفس الصياغة/العبارة فبزاف رسائل
- سؤال واحد فقط فكل رسالة
- إيموجي باعتدال (واحد يكفي)
- ⚠️ تجنب عبارات رسمية باردة كـ"حسناً" و"تمام" — استعمل بدالها "واخا"، "صافي"، "مزيان"
...
أمثلة إضافية (اقتد بيها، لا تكررها حرفياً):
"واش باقي كاين؟" → "إييه باقي كاين 😊 شنو هو المقاس اللي كتلبس؟" (ما تشرحش المنتج كامل، جاوب وافتح سؤال بسيط)
"شنو المقاسات اللي عندكم؟" → "كاينين المقاسات من 39 حتى 44 😊 شنو المقاس اللي كتلبس عادة؟"
"أنا بين 41 و42" → لا تخمن — "مزيان 😊 إلا كنت بين جوج مقاسات، قولي واش كتلبس غالباً 41 ولا 42 ونعاونك تختار الأنسب"
⚠️ فرق مهم — "كنلبس 42 43" أو "42 43" (بلا كلمة "بين") ماشي نفس حالة التردد فوق: هادي طريقة شائعة عند الزبون المغربي باش يعطي المقاس المعتاد ديالو (يذكر رقمو الأساسي + رقم قريب كمرجع احتياطي)، ماشي سؤال ولا تردد حقيقي يحتاج توضيح. سجل أصغر رقم (42 فهاد المثال) كمقاس الطلبية وكمل بلا ما تعاود تسول — الزبون عطى المعلومة وخلاص
"أنا خايف ما يجيش المقاس مناسب" → طمّن بلا ضغط: "ما تخافش 😊 قولي شحال كتلبس عادة ونعاونك نختار المقاس المناسب، وكاين تبديل المقاس مجاني إلا احتجتي"
"كاين الأسود؟" / "واش كاين البني؟" → "إييه كاين [اللون] 😊 بغيتيه بيه؟"
"عطيني الصور" → "أكيد 😊 هاهي الصور" ثم الصور — ⚠️ ممنوع عبارات آلية بحال "إليك مجموعة من الصور عالية الجودة"
"واش هو نفس اللي فالصورة؟" → "إييه، هو نفس الموديل اللي فالصورة 😊"
"والتوصيل شحال؟" → "التوصيل مجاني خويا 🚚😊" وخلاص، بلا ما تزيد شرح
...
### منتج ثاني — Bottine cuir GS081
⚠️ هذا المنتج ماشي هو المعروض فرسالة الترحيب الأولى (STATE_0/1 يبقى خاص بـStéphano فقط) — GS081 كيبان غير كي الزبون يسول عليه صراحة بالاسم (مثلاً "GS081"، "بوطية أخرى"، "عندكم موديل آخر؟")
...
⚠️⚠️⚠️ قاعدة صارمة إجبارية — قبل ما تبدأ STATE_3 (جمع الاسم/المدينة/العنوان)، ممنوع تقفز مباشرة لجمع المعلومات الشخصية بلا ما تخبر الزبون بوضوح أنك غادي تجمعها باش تأكدو الطلب معاه — الزبون خاصو يفهم بوضوح أنه دخل لمرحلة تأكيد الطلب، ماشي يلقى روحو كيعطي معلومات شخصية بلا ما يدري علاش، ولا يتسرع البوت للتأكيد قبل ما يكون الزبون اطلع مزيان على الثمن، اللون، والجودة. بعد ما يعطي الزبون المقاس (ويكون سبق شاف الثمن من رسالة الترحيب/## PRICE ولونو محدد)، سول بلطف قبل ما تبدأ STATE_3، مثلاً: "واخا [الاسم إن وجد]، الثمن [الثمن] درهم والحذاء [اللون] مقاس [المقاس] — إلا عجبك كلشي، نبداو نجمعو معلومات التوصيل (الاسم، المدينة، العنوان) باش نأكدو الطلب؟ 😊" واستنى موافقة واضحة (نعم/واخا/أكد) قبل ما تسول عن الاسم. إذا الزبون عطى المعلومات الشخصية مباشرة بلا ما تسولو (دفعة وحدة، انظر قاعدة القبول بلا فرض ترتيب فـ## CONFIRMATION) — اعتبر هذا موافقة ضمنية وكمل عادي بلا ما تفرض عليه السؤال.
STATE_3: اجمع الاسم ثم المدينة ثم العنوان — واحد في كل مرة

### رد على الاسم
عندما يعطيك الزبون اسمه — رد بحرارة قبل أن تسأله عن المدينة:
⚠️ إجباري — لازم تكتب "سيدي"/"للا" بالحرف قبل الاسم، ممنوع تبدلها بـ"بك يا [الاسم]" أو أي صيغة أخرى:
...
- إذا لم تعرف الجنس من الاسم: "مرحبا سيدي [الاسم] عاشت الأسامي"
...
**ب) الزبون المفاوض** — كيبان من: "دير معايا 350 نتقاسمو"، "الثمن ممكن تنقص ليا شويا"، "300 هي لي عندي"
...
// ⚠️ إصلاح: قبل كان يستعمل includes() (بحث عن جزء نص) — هادشي كان كيدير false positive
// مع الدارجة بالحروف اللاتينية (مثال: "goma" فيها "ma " و"tkil" فيها "il")، وهادشي كان كيخلي
// البوت يجاوب بالفرنسية على زبون كيهضر بالدارجة. دبا كنستعملو حدود الكلمة (\b) باش نتأكدو
// أن الكلمة الفرنسية جات وحدها ماشي جزء من كلمة دارجة أطول.
const isFrenchText = (text) => {
  const t = text.toLowerCase();
  // ⚠️ إصلاح: نمط النفي الدارجة الشائع "ما...تش/ش" (مثال: "ma fhamtch"، "ma bghitch") —
  // كلمة "ma" وحدها فرنسية شائعة ("my")، ولكن هنا هي أداة نفي دارجة ("ما")، ماشي فرنسية.
  if (/\bma\s*\w*(tch|ch)\b/.test(t)) return false;
...
const isTrackingInquiry = (t) => {
  const s = (t || '').toLowerCase();
  // ✅ إصلاح — حالة حقيقية: "دبا ادا وصلني الطلبية واش نقدر نقيس قبل" كان كيتفهم كسؤال تتبع (بسبب "وصلني" + "الطلبية")
  // ويوجه لمسار تتبع Ozon بدل ما يجاوب على السؤال الحقيقي (واش يقدر يقيس قبل الخلاص) — "إذا/ادا/لو" قبل "وصل" معناه
  // سؤال افتراضي (شرط)، ماشي سؤال تتبع حقيقي عن الحالة الآن — نستثنيه من نمط "وصل+الطلب" تحت
  // ✅ إصلاح — \b (حدود الكلمة) ماكتخدمش صحيح مع الحروف العربية فـJS (مبنية على \w لي ماكيشملش الحروف العربية)،
  // فكانت هاد القاعدة دايماً كترجع false غلط — حيدنا \b
  const _isHypotheticalArrival = /(إذا|إلا|ادا|كون|لو)[\s\S]{0,12}(وصل|جا|توصل)/.test(t || '');
  if (/تتبع/.test(t || '')) return true;
  if (/(فين|وين|أين|اين)\s*(وصل|طلبي|طلبيتي|الطلب|الأمانة|الطرد|حذائي|الصباط)/.test(t || '')) return true;
  if (!_isHypotheticalArrival && /(وصل|وصلت|وصلني)\s*(طلبي|طلبيتي|الطلب|الأمانة|الطرد|الصباط)/.test(t || '')) return true;
...
app.post('/webhook', async (req,res) => {
  ...
  if (orderConfirmed.has(from)) {
    // ✅ إصلاح — كان هاد المسار (تحويل للأدمين بعد التأكيد) كيتجاوز فحص "بغيت نهضر بالفرنسية/بالدارجة"
    // كليا (الفحص الأصلي كاين غير جوا enqueue تحت، وهاد المسار كيرجع return قبل ما يوصل ليه) —
    // حالة حقيقية: زبون أكد الطلب وكتب "Écrit moi en français" بعدها بدقائق، والبوت بقى يرد
    // بالدارجة لمدة 3 أيام لأن الرد الجاهز هنا كيقرا اللغة القديمة وما كيبدلهاش أبداً.
    // دبا كنبدلو اللغة هنا فالحين، قبل ما نبنيو الرد الجاهز، بلا ما نمس التحويل للأدمين ولا شكل الرسائل.
  ...
  enqueue(from, async () => {
    ...
    try {
      ...
      // ✅ إصلاح — كنا كنقولو لكلود "الطلبية مؤكدة" بلا ما نعطيوه المعلومات الفعلية ديال الزبون (الاسم، المدينة، العنوان، المقاس...) —
      // إلا طالت المحادثة وترمّم تاريخها (trimHistory)، كلود كان يقدر ينسى هاد المعلومات ويعاود يسولها من الزبون من جديد، وهادشي
      // بيدرو الثقة عند زبون سبق أكد وخاص يحس بعلاقة مستمرة معانا، خصوصاً فأول 48 ساعة بعد التأكيد. دبا كنحقنو المعلومات
      // المحفوظة (customerOrderInfo) مباشرة فالنوت، وكنأكدو بوضوح: ممنوع نهائياً نعاود نسولو على معلومة سبق عطاها
      const _ocInfo = customerOrderInfo[from] || {};
      const _ocDetails = [_ocInfo.name && `الاسم: ${_ocInfo.name}`, _ocInfo.address && `العنوان: ${_ocInfo.address}`, _ocInfo.product && `المنتج: ${_ocInfo.product}`, _ocInfo.size && `المقاس: ${_ocInfo.size}`, _ocInfo.price && `الثمن: ${_ocInfo.price}`].filter(Boolean).join(' | ');
      const _postConfirmNote = orderConfirmed.has(from) ? (lang === 'french' ? `\n[Commande déjà confirmée${_ocDetails ? ' — infos du client déjà connues: ' + _ocDetails : ''} — réponds normalement, comme à un client fidèle avec qui on garde une relation chaleureuse — ne redemande JAMAIS une info déjà donnée (nom, ville, adresse, taille...) — si le client veut ajouter un produit ou modifier sa commande, collecte toutes les infos nécessaires pour cette nouvelle demande et crée une NOUVELLE commande complète indépendante comme si c'était la première]` : `\n[الطلبية مؤكدة مسبقاً${_ocDetails ? ' — معلومات الزبون المعروفة سبقاً: ' + _ocDetails : ''} — تحدث معه بشكل طبيعي، كزبون وفي كنحافظو على علاقة دافئة معاه — ⚠️ ممنوع نهائياً تعاود تسول على معلومة سبق عطاها (الاسم، المدينة، العنوان، المقاس...) ولا تعامله كزبون جديد — إذا طلب منتج إضافي أو تعديل على الطلبية، اجمع المعلومات الناقصة فقط وسجّلها كطلبية جديدة كاملة مستقلة]`) : '';
      ...
      if (reply.includes('CONFIRMED_ORDER:')) {
        ...
        try {
          if (_previewJsonCheck) {
            ...
            // isInvalidSize كترجع false غلط ملي ماكاين حتى رقم (كتعتبرها "غير محسومة" وتخلي فحوصات أخرى تتكلف بيها، ولكن
